...
//Variables
// var maxLimit = STAKE_FOR_EVERY_DAY + (STAKE_FOR_EVERY_DAY * 50 / 100)
// var minLimit = STAKE_FOR_EVERY_DAY - (STAKE_FOR_EVERY_DAY * 50 / 100)
var cash = 0
var winnigCash = 0
var totalAmount = 0
var dictionary = {}
...
function playNextMonth() {
    monthlyGambling()
    //Ternary operator
    totalAmount > 0 ? console.log("Gamble playing for next month") : console.log("Stop playing");
}
playNextMonth()